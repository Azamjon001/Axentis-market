...
const translations = {
  ru: {
    // 📲 Вход по SMS-коду
    smsLogin: 'Войти по SMS-коду',
    smsLoginHint: 'Без пароля — пришлём код подтверждения',
    sendCode: 'Получить код',
    smsCodeSent: 'Код отправлен',
    smsCodeSentTelegram: 'Код отправлен в Telegram',
    smsCodeLabel: 'Код из SMS',
    enterSmsCode: 'Введите 6-значный код',
    ...
    // 🔒 Закрытая компания
    privateCompanyMode: 'Закрытая компания',
    publicMarketMode: 'Общий маркет',
    companyIdLabel: 'ID компании',
    companyIdPlaceholder: 'Код доступа от вашей компании',
    checkCompanyId: 'Проверить',
    companyFound: 'Компания найдена',
    companyNotFound: 'Компания с таким ID не найдена',
    privateModeHint: 'Вам будут видны только товары этой компании',
    home: 'Главная',
    cart: 'Корзина',
    favorites: 'Избранное',
    profile: 'Профиль',
    ...
    selectColorFirst: 'Сначала выберите один из вариантов',
    ...
    // 🆕 Новые функции: наличие, флеш, коллекции, баллы
    notifyStockCta: 'Уведомить о поступлении',
    notifyStockDone: 'Сообщим о поступлении',
    notifyStockTitle: 'Уведомить о поступлении',
    notifyStockNeedLogin: 'Войдите, чтобы получить уведомление, когда товар появится.',
    flashSale: 'Флеш-распродажа',
    loginToFavorite: 'Войдите, чтобы добавлять товары в избранное.',
    login: 'Войти',
    collectionDiscounted: 'Со скидкой',
    collectionNew: 'Новинки',
    collectionBudget: 'До 100 000 сум',
    onlyLeftStock: 'Осталось всего {n} шт.',
    bundleTitle: 'Вместе дешевле',
    bundleAddAll: 'Добавить комплект в корзину',
    bundleHint: 'Скидка применится автоматически при оформлении заказа',
    bundleWord: 'Комплект',
    ...
    completedOrdersWord: 'Заказов',
    promoPlaceholder: 'Промокод',
    promoInvalid: 'Промокод недействителен',
  },
  uz: {
    // 📲 SMS-kod orqali kirish
    smsLogin: 'SMS-kod orqali kirish',
    smsLoginHint: 'Parolsiz — tasdiqlash kodini yuboramiz',
    sendCode: 'Kod olish',
    smsCodeSent: 'Kod yuborildi',
    smsCodeSentTelegram: 'Kod Telegramga yuborildi',
    smsCodeLabel: 'SMS-dagi kod',
    ...
    // 🔒 Yopiq kompaniya
    privateCompanyMode: 'Yopiq kompaniya',
    publicMarketMode: 'Umumiy market',
    companyIdLabel: 'Kompaniya ID',
    companyIdPlaceholder: 'Kompaniyangiz bergan kirish kodi',
    checkCompanyId: 'Tekshirish',
    companyFound: 'Kompaniya topildi',
    companyNotFound: 'Bunday ID bilan kompaniya topilmadi',
    privateModeHint: 'Sizga faqat shu kompaniya mahsulotlari ko‘rinadi',
    home: 'Bosh sahifa',
    cart: 'Savat',
    ...
    selectColorFirst: 'Avval variantlardan birini tanlang',
    ...
    // 🆕 Yangi funksiyalar
    notifyStockCta: 'Kelishi haqida xabar berish',
    notifyStockDone: 'Kelganda xabar beramiz',
    notifyStockTitle: 'Kelishi haqida xabar',
    notifyStockNeedLogin: "Tovar paydo bo'lganda xabar olish uchun kiring.",
    flashSale: 'Fleş-chegirma',
    loginToFavorite: "Sevimlilarga qo'shish uchun tizimga kiring.",
    login: 'Kirish',
    collectionDiscounted: 'Chegirmada',
    collectionNew: 'Yangi tovarlar',
    collectionBudget: "100 000 so'mgacha",
    onlyLeftStock: 'Atigi {n} dona qoldi',
    bundleTitle: 'Birgalikda arzonroq',
    bundleAddAll: "To'plamni savatga qo'shish",
    bundleHint: "Chegirma buyurtma rasmiylashtirishda avtomatik qo'llanadi",
    bundleWord: "To'plam",
    articleLabel: 'Artikul',
    brandLabel: 'Brend',
    materialLabel: 'Material',
    screenLabel: 'Ekran',
    characteristics: 'Xususiyatlari',
    completedOrdersWord: 'Buyurtmalar',
    promoPlaceholder: 'Promokod',
    promoInvalid: 'Promokod yaroqsiz',
  },
};
