...
const translations = {
  ru: {
    ...
    payWithPoints: 'Оплатить баллами',
    willEarnPoints: 'Кэшбэк за заказ: +{n} баллов',
    yourPoints: 'Ваши баллы',
    pointsHint: '1 балл = 1 сум скидки',
  ...
  uz: {
    ...
    payWithPoints: "Ballar bilan to'lash",
    willEarnPoints: "Buyurtma uchun keshbek: +{n} ball",
    yourPoints: 'Ballaringiz',
    pointsHint: "1 ball = 1 so'm chegirma",
